...
class CarSerializer(serializers.ModelSerializer):
    ...
    # View de get_serializer_class methode u override edilerek user a göre serializerlar seçilebilir. Plaka numarası ve müsaitlik durumunu sadece staff olan kullanıcı görebilir
